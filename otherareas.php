...
<table width="800" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <TD valign=top><TABLE width="600" ALIGN=left>
        <TR>
          <td align="center" valign="top" class="generalHeading"><div>&nbsp;&nbsp;</div>
        </TR>
        <TR>
          <td align="center" valign="top"><div class="pageHeading">Links to Other Areas</div>
        </TR>
        <TR>
          <td align="center" valign="top"><div><img src="images/acnvrule.gif" width="600" height="10"></div>
        </TR>
        <TR>
          <td align="center" valign="top"><div class="generalText">For a complete directory of
...
<!--
        ...
        -->
        <TR>
          <td align="center" valign="top"><div class="generalText">Please Note: By following the above links, you will be leaving the Suffolk Intergroup
              Association's website. This link is provided solely as a
              convenience. The Suffolk Intergroup Association is not responsible for
              any content on these websites.</div>
        </TR>
      </TABLE></TD>
  </tr>
