...
echo "<div align=center>All meetings for $g.</div><div class=tblMeetHead align=center>All meetings are PM unless otherwise noted.</div><div class=tblMeetHead align=center>All meetings are NON-Smoking unless otherwise noted.</div>";
else if (!empty($a))
