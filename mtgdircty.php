...
<table border="0">
  <tr>
    <td width="135" align="left" valign="top"><? readfile("menu.php"); ?></td>
    <td width="600" valign="top"><table border="0">
      <tr valign="top">
        <td align="center">&nbsp;</td>
      </tr>
      <tr valign="top">
...
?>
  ...
  <TR>
    <TD colspan="6" align="center" VALIGN="middle" nowrap="nowrap" bordercolor="#0000FF">DO NOT use this directory for mailings.</TD>
    </TR>
  <TR>
